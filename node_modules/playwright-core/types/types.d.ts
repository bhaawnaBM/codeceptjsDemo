...
export interface Page {
  ...
  /**
   * The method finds an element matching the specified selector within the page. See Working with selectors for more details. If no elements match the selector, the return value resolves to `null`.
  ...
  /**
   * The method finds all elements matching the specified selector within the page. See Working with selectors for more details. If no elements match the selector, the return value resolves to `[]`.
   * Shortcut for page.mainFrame().$$(selector).
   * @param selector A selector to query page for
   */
  ...
  /**
   * The method finds an element matching the specified selector within the page and passes it as a first argument to `pageFunction`. See Working with selectors for more details. If no elements match the selector, the method throws an error.
  ...
  /**
   * The method finds all elements matching the specified selector within the page and passes an array of matched elements as a first argument to `pageFunction`. See Working with selectors for more details.
   * If `pageFunction` returns a Promise, then `page.$$eval` would wait for the promise to resolve and return its value.
   * Examples:
   * ```js
   ...
   * ```
   * @param selector A selector to search for element to use. If there are multiple elements satisfying the selector, the first will be used.
   ...
   * @returns .
   */
  route(url: string|RegExp|((arg0 : string) => boolean), handler: ((arg0 : Route, arg1 : Request) => void)): Promise<void>;
   ...
   */
  selectOption(selector: string, values: string|ElementHandle|Array<string>|PageSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: PageSelectOptionOptions): Promise<Array<string>>;
   ...
   * @param handler Handler function to route the request.
   */
  unroute(url: string|RegExp|((arg0 : string) => boolean), handler?: ((arg0 : Route, arg1 : Request) => void)): Promise<void>;
...
export interface Frame {
   ...
   * ```
   * @param selector A selector to search for element to use. If there are multiple elements satisfying the selector, the first will be double clicked.
   * @param type DOM event type: `"click"`, `"dragstart"`, etc.
   * @param eventInit event-specific initialization properties.
   * @param options 
   */
   ...
   * @returns An array of option values that have been successfully selected.
   */
  selectOption(selector: string, values: string|ElementHandle|Array<string>|FrameSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: FrameSelectOptionOptions): Promise<Array<string>>;
...
export interface ElementHandle<T=Node> extends JSHandle<T> {
   ...
   * @returns Resolves to the attribute value.
   */
   ...
   */
  innerHTML(): Promise<null|string>;

  /**
   * @returns Resolves to the `element.innerText`.
   */
  innerText(): Promise<null|string>;
   ...
   * @returns An array of option values that have been successfully selected.
   */
  selectOption(values: string|ElementHandle|Array<string>|ElementHandleSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: ElementHandleSelectOptionOptions): Promise<Array<string>>;

  /**
   * This method focuses the element and selects all its text content.
   * @returns Promise which resolves when the element is successfully selected.
   */
